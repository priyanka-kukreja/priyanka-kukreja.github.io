...
Sparse networks are often used in deep learning because they have two main benefits over dense networks:
...
2. Sparse networks can be more computationally efficient than dense networks, making them better suited for deployment on devices like mobile phones and VR headsets, which have limited storage and compute available.
...
A few places where sparse NNs are used today:
